...
class InventoryFoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory_food" do
    assert_difference("InventoryFood.count") do
      post inventory_foods_url, params: { inventory_food: { food_id: @inventory_food.food_id, quantity: @inventory_food.quantity, user_id: @inventory_food.user_id } }
    end
  ...
  test "should update inventory_food" do
    patch inventory_food_url(@inventory_food), params: { inventory_food: { food_id: @inventory_food.food_id, quantity: @inventory_food.quantity, user_id: @inventory_food.user_id } }
